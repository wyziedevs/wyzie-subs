...
type LanguageMetadata = { name: string; nativeName: string };
type LanguageMetadataMap = { [key: string]: LanguageMetadata };

// table of all languages to the locale country it is usually spoken in
export const languageToCountryCode: { [key: string]: string } = {
  pb: "BR", // Portuguese (Brazil)
  af: "ZA",
  ak: "GH",
  ar: "SA",
  az: "AZ",
  ...
  el: "GR",
  en: "US",
  eo: "PL", // Esperanto was created in Poland
  es: "ES",
  et: "EE",
  fa: "IR",
  fi: "FI",
...
export const subDLlanguageToCountryCode: LanguageMetadataMap = {
  ...
  pb: { name: "Portuguese (Brazil)", nativeName: "Português do Brasil" },
  ze: { name: "Chinese (Simplified)", nativeName: "简体中文" },
  zt: { name: "Chinese (Traditional)", nativeName: "繁體中文" },
...
export function getLanguageMetadata(code: string): LanguageMetadata | undefined {
  ...
  return subDLlanguageToCountryCode[normalizedCode];
}

export function listLanguageCodes(): string[] {
  return Object.keys(subDLlanguageToCountryCode);
}
